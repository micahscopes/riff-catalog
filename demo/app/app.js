...
const CH = [
  ...
  },
  {
    ...
    title: "Transposed, the riff is still the riff.",
  ...
  },
  {
    ...
    title: "The forks that edited the code still match.",
  ...
  },
  {
    ...
    title: "The dial finds Forte's catalog on its own.",
  ...
  { nav: "interval vector", kicker: "the harmonic signature underneath a chord", title: "Six numbers that survive transposing and flipping.", lede: "Every chord projects to six interval-class counts, minor second up through the tritone; move it to any key or flip it over and the six numbers hold. Pick a chord; major and minor land on the same signature.", body: "<ivf-fingerprint></ivf-fingerprint>" },
  { nav: "three rungs", kicker: "one chord, three rungs of forgetting", title: "A pitch-class set has a ladder, not a switch.", lede: "Take one chord up the ladder: the literal notes; the tightest packing with transposition forgotten (Tn-type, still 3-11B); the prime form, where inversion folds and 3-11B merges with 3-11A into 3-11. Each rung forgets one more thing.", body: `<three-rungs></three-rungs>` },
  { nav: "two fingerprints", kicker: "two axes, not two rivals", title: "The compiler already emits a fingerprint. This is its complement.", lede: "Sourcify's metadata hash answers \"is this the identical build\" and flips on a single whitespace; the structural fingerprint answers \"is this the same code wearing different clothes\" and is built to hold when the hash moves. Edit the source and watch the axes part.", body: `<metadata-axes></metadata-axes>` },
  {
  nav: "main vs meta",
  kicker: "the wall riffcat steps around",
  title: "A byte match has to guess.",
...
},
  {
    ...
    title: "The engine is on the table.",
